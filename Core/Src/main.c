...
/*Numero de canais para converter*/
#define ADC_NUM_CONVERSIONS 14
#define ADC_PURE_VOLTAGE 0.00005035477
/* USER CODE END PD */
...
/*vetor global de 16bits inteiros*/
volatile uint16_t adcData[ADC_NUM_CONVERSIONS];
volatile float sensorVoltage[ADC_NUM_CONVERSIONS];
/* USER CODE END PV */
